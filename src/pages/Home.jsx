      ...
      <div className="w-[90%] mx-[auto] grid gap-5 lg:grid md:grid-cols-2 lg:grid-cols-3 gap-10 min-h-[500px] relative">
        ...
        <div
          ...
          data-aos="fade-up">
            ...
            <div className="bg-slate-900 shadow-lg rounded-lg p-2 absolute bottom-40 right-0">
              <VscVscode className="text-5xl text-blue-500"/>
            </div>
            <div className="bg-slate-900 shadow-lg p-2 absolute bottom-40 rounded-lg"><SiVitess className="text-5xl text-purple-600"/></div>
